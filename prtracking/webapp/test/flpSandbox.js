		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PR Tracking",
									"targetURL": "#scrprtracking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"scrprtracking-display": {
								"semanticObject": "scrprtracking",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=scr.prtracking",
									"url": sap.ui.require.toUrl("scr/prtracking")
								}
							}
						}
					}
